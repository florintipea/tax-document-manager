...
export function Navbar() {
  ...
  const navItems = [
    ...
    { href: "/steuererklaerung", label: t('common.steuererklaerung'), icon: ClipboardCheck, highlight: true, highlightLabel: t('nav.steuererklaerung') },
    // tax-forms (WISO-like stub) soft-hidden from main nav — still reachable via URL if needed
              ...
              <>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive("/admin/tester-activity")
                      ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400"
                      : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700"
                  )}
                >
                  <Activity className="w-4 h-4" />
                  {t("testerActivity.nav")}
                </Link>
              </>
            )}
