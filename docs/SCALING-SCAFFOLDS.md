...
> **Growth note:** Ziel „1 Mio. deutsche Abonnenten / Jahr“ erfordert skalierfähiges Produkt + Marketing — nicht nur Uptime. Tägliche Checks: [`docs/ops/DAILY-HEALTH.md`](./ops/DAILY-HEALTH.md). Growth-Plan: [`docs/growth/PATH-TO-1M-DE-12MONTHS.md`](./growth/PATH-TO-1M-DE-12MONTHS.md). Monitoring allein erzeugt keine Abonnenten.
