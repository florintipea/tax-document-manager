...
import { Send, Bot, User, Sparkles, AlertTriangle, Settings } from "lucide-react";
...
function getChatErrorMessage(
  ...
  return body?.error || t("aiAssistant.errorGeneric");
}
...
export default function AIAssistantPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!input.trim() || isLoading || isAiStatusLoading || !aiConfigured) return;
