...
import { getClientIp } from '@/lib/auth/two-factor';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = enableSchema.safeParse(body);
    ...
    await logTwoFactorEvent(userId, '2fa_enabled', 'Two-factor authentication enabled', 'low', getClientIp(request));
