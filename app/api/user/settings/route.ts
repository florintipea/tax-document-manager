...
const updateSchema = z.object({
  ...
  /** Clear banner after user acknowledges prior-ELSTER profile refresh */
  profileRefreshNotice: z.string().max(500).nullable().optional(),
...
const settingsSelect = {
  ...
  profileRefreshNotice: true,
  profileRefreshedAt: true,
