...
<body>
  ...
  <table>
    ...
    const german = /no such table|does not exist|P2021/i.test(message)
      ? 'Checkliste nicht verfügbar — Datenbanktabellen fehlen. Bitte nach dem Deploy erneut versuchen.'
      : 'Checkliste konnte nicht erzeugt werden. Bitte erneut versuchen.';
    return NextResponse.json({ error: german, code: 'ELSTER_EXPORT_FAILED' }, { status: 500 });
  }
}
