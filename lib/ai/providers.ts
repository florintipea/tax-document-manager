...
class MultiProviderAIService {
  ...
  private async getGoogleResponse(
    ...
    const modelName = this.models.google || process.env.GOOGLE_MODEL || 'gemini-pro';
  ...
  private buildSystemPrompt(context?: Record<string, any>): string {
    let prompt = `You are an expert tax advisor AI assistant. You help users with:
...
Always provide accurate, helpful, and compliant advice. If you're unsure, recommend consulting a professional tax advisor.`;
    ...
    if (context) {
      ...
      if (context.documentCount !== undefined) {
        prompt += `\n\nUser has ${context.documentCount} documents`;
      }
    }
