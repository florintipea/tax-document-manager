...
const DE_CATEGORIES: DefaultCategory[] = [
  ...
  { name: 'Immobilienkauf', icon: '🏗️', color: '#0EA5E9' },
  { name: 'Nebenkostenabrechnung', icon: '🧾', color: '#F97316' },
  { name: 'Hausgeldabrechnung', icon: '🏢', color: '#EA580C' },
  { name: 'Vermietung & Verpachtung', icon: '🏘️', color: '#14B8A6' },
  { name: 'Kapitalerträge', icon: '📈', color: '#22C55E' },
  { name: 'Werbungskosten', icon: '🧳', color: '#6366F1' },
  { name: 'Sonderausgaben', icon: '📌', color: '#A855F7' },
  { name: 'Außergewöhnliche Belastungen', icon: '⚕️', color: '#E11D48' },
  { name: 'Apotheke/Gesundheit', icon: '💊', color: '#DB2777' },
  { name: 'Spenden', icon: '❤️', color: '#DC2626' },
  { name: 'Lohnausweis Ausland', icon: '🌍', color: '#0284C7' },
  { name: 'Quellensteuer-Bescheinigung', icon: '🧾', color: '#0369A1' },
  { name: 'A1-Bescheinigung', icon: '🪪', color: '#075985' },
  { name: 'Ansässigkeitsbescheinigung', icon: '🏠', color: '#0C4A6E' },
  { name: 'Grenzgänger-Nachweis', icon: '🛂', color: '#164E63' },
