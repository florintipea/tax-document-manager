/**
 * Creates 50 tester accounts for friend beta testing.
 * Re-run safely: existing accounts are updated (password reset to default).
 */
...
async function main() {
  ...
  writeFileSync(
    txtPath,
    [
      'TaxDoc – 50 Test-Accounts für Freunde',
      '====================================',
      '',
