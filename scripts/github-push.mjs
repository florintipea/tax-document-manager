...
function walkFiles(dir, base = dir) {
  ...
  for (const entry of entries) {
    ...
    // Skip workflow files — PAT needs `workflow` scope (see prepare-github-upload.mjs).
    if (rel === '.github/workflows/ci.yml' || rel.startsWith('.github/workflows/')) continue;
